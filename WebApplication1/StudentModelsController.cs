...
namespace WebApplication1
{
    public class StudentModelsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,LastName,MiddleName,FamilyName,Class")] StudentModel studentModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Id,LastName,MiddleName,FamilyName,Class")] StudentModel studentModel)
        {
